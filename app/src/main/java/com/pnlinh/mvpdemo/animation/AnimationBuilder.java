package com.pnlinh.mvpdemo.animation;
...
public class AnimationBuilder {
     ...
     * @return the animation builder
     */
    public AnimationBuilder property(Property<View, Float> propertyName, float... values) {
        for (View view : views) {
    ...
    public AnimationBuilder translationY(float... y) {
        return property(View.TRANSLATION_Y, y);
    }
    ...
    public AnimationBuilder alpha(float... alpha) {
        return property(View.ALPHA, alpha);
    }
    ...
    public AnimationBuilder scaleX(float... scaleX) {
        return property(View.SCALE_X, scaleX);
    }
    ...
    public AnimationBuilder scaleY(float... scaleY) {
        return property(View.SCALE_Y, scaleY);
    }
    ...
    public AnimationBuilder rotationX(float... rotationX) {
        return property(View.ROTATION_X, rotationX);
    }
    ...
    public AnimationBuilder rotationY(float... rotationY) {
        return property(View.ROTATION_Y, rotationY);
    }
    ...
    public AnimationBuilder rotation(float... rotation) {
        return property(View.ROTATION, rotation);
    }
    ...
    /**
     * Svg path animation, path toggleLike as:
